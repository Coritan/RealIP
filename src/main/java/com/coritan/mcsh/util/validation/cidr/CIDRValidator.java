package com.coritan.mcsh.util.validation.cidr;

import com.coritan.mcsh.MCSHPlugin;
import com.coritan.mcsh.util.exception.phase.CIDRException;
...
public class CIDRValidator {
	...
	public CIDRValidator(MCSHPlugin plugin) throws CIDRException {
		this.plugin = plugin;
