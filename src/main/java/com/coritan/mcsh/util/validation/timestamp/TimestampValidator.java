package com.coritan.mcsh.util.validation.timestamp;
...
public abstract class TimestampValidator {
	 ...
	 */
	public static TimestampValidator createEmpty(MCSHPlugin plugin) {
	 ...
	 */
	public static TimestampValidator createDefault(MCSHPlugin plugin) {
		return new TimestampValidator(plugin) {
	...
	protected final MCSHPlugin plugin;

	public TimestampValidator(MCSHPlugin plugin) {
		this.plugin = plugin;
	}
